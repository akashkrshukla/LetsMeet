                ...
                if (!s.allDay && s.duration().days() < 1 || !D) {
                    ...
                    for (var W = 0; W < r.length; W++) {
                        ...
                        var ab = {
                            ...
                            width: c,
                            appointment: s,
                            from: a.jqx.scheduler.utilities.getStartOfDay(new a.jqx.date(v[0].date, M.timeZone)),
                            to: S
                        };
                        B.push(ab);
                        J.push(ab)
