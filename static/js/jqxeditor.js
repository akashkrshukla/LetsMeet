                ...
                case "custom":
                    switch (d.type) {
                        ...
                        case "colorPicker":
                            h = function(m) {
                                if (e._documentMode != "source") {
                                    var k = b(d.colorPicker).find("td").removeClass("jqx-editor-color-picker-selected-cell");
                                    if (m.target.nodeName.toLowerCase() == "div") {
                                        var l = b(m.target).css("background-color");
                                        b(m.target).parent().addClass("jqx-editor-color-picker-selected-cell")
                                    } else {
                                        var l = b(m.target).find("div").css("background-color");
                                        b(m.target).addClass("jqx-editor-color-picker-selected-cell")
                                    }
                                    ...
                                    d.widget.val = function() {
                                        var o = function(q) {
                                            ...
                                            return "rgb(" + (q & 255) + ", " + ((q & 65280) >> 8) + ", " + ((q & 16711680) >> 16) + ")"
                                        };
                                        var p = o(l);
                                        var n = e._rgbToHex(p);
                                        return n
                    ...
                    h = function(k) {
                        if (e._documentMode != "source") {
                            if (k.args.type != "none") {
                                ...
                                var l = b(this).jqxDropDownList("getSelectedIndex") + 1;
                                var l = 1 + n.indexOf(m);
                                ...
                                if (e.getSelectedElement()) {
                                    ...
                                    if (m && m.nodeName.toLowerCase() == "a") {
                                        if (d.toggled) {
                                            ...
                                            b(m).css("text-decoration", "underline")
                                        }
                                        d.toggle();
                                        e._refreshTools();
                                        return false
